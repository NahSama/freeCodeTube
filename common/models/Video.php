...
{   
    ...
    */
    ...
    {
        return [
            //To update created_at and updated_at
            TimestampBehavior::class,
            [   
                //To update created_by and updated_by
    ...
    {
        return Yii::$app->params['frontendHost'].'/storage/videos/'.$this->video_id.'.mp4';
    }

    public function getThumbnailLink()
    {
        return ($this->has_thumbnail == 1) ? Yii::$app->params['frontendHost'].'/storage/thumbs/'.$this->video_id.'.jpg' : '';
    }
